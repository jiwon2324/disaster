...
public class DisasterInfoController {
    ...
    public ResponseEntity<List<DisasterInfoVO>> getListByCategory(@PathVariable("catid") Long catid) {
    ...
    public ResponseEntity<Page<DisasterInfoVO>> getListByCategoryPaged(
    ...
    public ResponseEntity<DisasterInfoVO> getDisasterDetail(@PathVariable("id") Long id) {
    ...
    @PostMapping
    public ResponseEntity<Long> createDisaster(@RequestBody DisasterInfoRequestVO requestVO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateDisaster(
