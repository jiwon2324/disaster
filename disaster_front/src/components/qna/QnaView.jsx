...
function QnaView() {
    ...
    const isQuestionOwner =
        Boolean(loginId) &&
        loginId === question.writerId;

    const canEditQuestion =
        isQuestionOwner && !answer;

    const canManageAnswer =
        Boolean(answer) &&
        isAdmin &&
        loginId === answer.writerId;
    ...
    return (
        ...
        */}
                {isAdmin &&
                    ...
                    !isQuestionOwner && (
                        <section
                            style={styles.answerFormCard}
                        >
                            <h3
                                style={styles.answerFormTitle}
                            >
                                답변 등록
                            </h3>
